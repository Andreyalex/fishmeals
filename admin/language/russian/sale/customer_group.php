...
$_['entry_approval']    = 'Подтверждение новых покупателей:Зарегистрированные покупатели должны быть проверены и подтверждены администратором, только после этого смогут пользоваться своей учетной записью и преимуществами зарегистрированных пользователей.';
