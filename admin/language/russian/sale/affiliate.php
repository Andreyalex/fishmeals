...
$_['entry_code']                = 'Код отслеживания:Этот код используется для отслеживания рефералов.';
$_['entry_commission']          = 'Вознаграждение (%):Процент, которые партнер получает за каждый заказ.';
$_['entry_tax']                 = 'ИНН:';
