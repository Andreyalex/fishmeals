...
$_['entry_password']     = 'Payment Response Password:This has to be set in the WordPay control panel.';
$_['entry_callback']     = 'Relay Response URL:This has to be set in the WordPay control panel. You will also need to check the Enable the Shopper Response.';
