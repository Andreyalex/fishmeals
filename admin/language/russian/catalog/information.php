...
$_['entry_keyword']     = 'SEO URL:Заменяйте пробелы на знак -. Значение этого поля должно быть уникальным на всю систему.';
$_['entry_bottom']      = 'Показывать внизу:Показывать внизу, в футере.';
