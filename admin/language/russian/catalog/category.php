...
$_['entry_filter']           = 'Фильтры:(Автодополнение)';
$_['entry_store']            = 'Магазины:';
$_['entry_keyword']          = 'SEO Keyword:Заменяйте пробелы на знак -. Значение этого поля должно быть уникальным на всю систему.';
$_['entry_image']            = 'Изображение категории:';
$_['entry_top']              = 'Главное меню:Показывать в главном меню (только для главных родительских категорий).';
$_['entry_column']           = 'Столбцы:Количество столбцов в выпадающем меню категории (только для главных родительских категорий).';
